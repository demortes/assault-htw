...
bool mem_log;
void insert_areaargs ( ( AREA_DATA *pArea) ); /* Auto-sort of areas */
 ...
 */
void init_mmargs( ( void ) );

void load_areaargs( ( FILE *fp ) );
void load_helpsargs( ( FILE *fp ) );
void load_objectsargs( ( FILE *fp ) );
void load_resetsargs( ( FILE *fp ) );
void load_roomsargs( ( FILE *fp ) );
void load_specialsargs( ( FILE *fp ) );
void load_objfunsargs( ( FILE *fp ) );
void load_goldargs( ( void ) );
void load_alliancesargs( ( void ) );
void load_changesargs( ( void ) );
void load_logsargs( ( void ) );
void read_map_from_fileargs( ( void ) );
void create_load_listargs( ( void ) );
void load_buildingsargs( ( void ) );
void load_scoresargs( ( void ) );
void load_multiplayargs( ( void ) );
void load_ranksargs( ( void ) );
void load_quotesargs( ( void ) );
void load_bansargs( ( void ) );
void load_brandsargs( ( void ) );

void fix_exitsargs( ( void ) );
void check_resetsargs( ( void ) );

void copyover_recoverargs( ( void ) );
void init_dealerargs( ( void ) );
