...
char *get_wolf_auspice        args( ( int auspice ) );
...
char *  item_type_desc        args( ( int type              ) );
char *  affect_loc_name       args( ( int location          ) );
char *  affect_bit_name       args( ( int vector            ) );
char *  raffect_bit_name      args( ( int vector            ) );

char *  material_name         args( ( int type          ) );
...
void    smash_system          args( ( char *str ) );
char *  smash_swear          args( ( char *str ) );
